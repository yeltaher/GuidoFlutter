...
extern "C" QUERY_UIDEVICE_PROPERTY(UnityDeviceName, name)
extern "C" QUERY_UIDEVICE_PROPERTY(UnitySystemName, systemName)
extern "C" QUERY_UIDEVICE_PROPERTY(UnitySystemVersion, systemVersion)
