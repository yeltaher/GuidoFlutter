...
class _CustomUnityButtonState extends State<CustomUnityButton> with SingleTickerProviderStateMixin {
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                            ...
                            color: widget.isLocked 
                                ...
                                : AppColors.getTextColor(Theme.of(context).brightness == Brightness.dark),
                            letterSpacing: 1.5,
                          ),
                        ),
                      ),
