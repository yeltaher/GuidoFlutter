      ...
      child: SafeArea(
        ...
        child: SingleChildScrollView(
          padding: const EdgeInsets.fromLTRB(
            ...
            24.0,
            110.0,
          ), // Aggiunto padding inferiore extra per permettere al diario di salire sopra la barra fluttuante
          child: Column(
            ...
            children: [
              ...
              Text(
                settings.language == 0
                    ? "Come ti senti in questo istante?"
              ...
              if (_entries.isNotEmpty) ...[
                ...
                ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    if (entry.mood == 'Grateful')
                      moodIcon = Icons.favorite_border_rounded;
                    if (entry.mood == 'Quiet')
                      moodIcon = Icons.nights_stay_outlined;
                    if (entry.mood == 'Restless')
                      moodIcon = Icons.bubble_chart_outlined;
