...
class _HomeContainerViewState extends ConsumerState<HomeContainerView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      extendBody: true, // Consente alle pagine di estendersi sotto la bottom navigation bar fluttuante occupando tutto lo schermo
      body: Container(
        ...
        child: Stack(
          children: [
            SafeArea(
              top: false, // Per consentire al gradiente dello sfondo di estendersi fino al notch
              bottom: false, // Consente il riempimento completo e fluttuante sotto la barra
              left: false,
              right: false,
              child: PageView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  switch (index) {
                    case 0:
                      tabWidget = HomeJapandiTab(isActive: currentIndex == index);
                      break;
                    case 3:
                  ...
                  return AnimatedBuilder(
                    ...
                    builder: (context, child) {
                      ...
                      final double rotationY = value * -0.12; // Leggera rotazione 3D sull'asse Y
          ...
          Positioned(
            ...
            child: ClipRRect(
              ...
              child: BackdropFilter(
                ...
                child: Container(
                  decoration: BoxDecoration(
                    color: isDark ? cardColor.withOpacity(0.25) : cardColor.withOpacity(0.12),
                    borderRadius: BorderRadius.circular(30),
                    border: Border.all(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        _buildNavItem(0, Icons.home_rounded, Icons.home_rounded, "Home", isDark, accentColor, subColor, textColor),
                        _buildNavItem(1, Icons.spa_outlined, Icons.spa, "Meditate", isDark, accentColor, subColor, textColor),
                        _buildNavItem(2, Icons.book_outlined, Icons.book, "Journal", isDark, accentColor, subColor, textColor),
                        _buildNavItem(3, Icons.person_outline, Icons.person, "Me", isDark, accentColor, subColor, textColor),
                        _buildNavItem(4, Icons.settings_outlined, Icons.settings, "Settings", isDark, accentColor, subColor, textColor),
                      ],
                    ),
                  ),
                ),
        ...
        children: [
          ...
          AnimatedContainer(
            ...
            child: Icon(
              ...
              color: isSelected ? accentColor : subColor.withOpacity(0.7),
              size: 24,
            ),
          ),
          ...
          Text(
            ...
            style: TextStyle(
              ...
              color: isSelected ? textColor : subColor.withOpacity(0.6),
              letterSpacing: 0.2,
            ),
          ),
